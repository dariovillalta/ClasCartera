...
export default class EditarComportamientoPago extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            request.query("update ComportamientoPago set prestamoTablaID = "+prestamoTablaID+", planPagoTablaID = "+planPagoTablaID+", idClientePrestamoCampoID = "+idClientePrestamoCampoID+", numeroPrestamoCampoID = "+numeroPrestamoCampoID+", pagoCapitalPrestamoCampoID = "+pagoCapitalPrestamoCampoID+", pagoImpuestosPrestamoCampoID = "+pagoImpuestosPrestamoCampoID+", fechaPrestamoCampoID = "+fechaPrestamoCampoID+", idClientePlanPagoCampoID = "+idClientePlanPagoCampoID+", numeroPlanPagoCampoID = "+numeroPlanPagoCampoID+", pagoCapitalPlanPagoCampoID = "+pagoCapitalPlanPagoCampoID+", pagoImpuestosPlanPagoCampoID = "+pagoImpuestosPlanPagoCampoID+", fechaPlanPagoCampoID = "+fechaPlanPagoCampoID+", comparacionEsPlanPago = '"+comparacionEsPlanPago+"' where ID = "+this.props.comportamientoPagoSel.ID, (err, result) => {
                if (err) {
                    ...
                    transaction.commit(err => {
                        ...
                        this.showSuccesMessage("Exito", "Comportamiento de Pago modificado con éxito.");
                    });
                }
            });
        }); // fin transaction camposPrestamos
