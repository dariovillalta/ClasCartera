...
export default class SeleccionarRegla extends React.Component {
    ...
    loadRules() {
        ...
        transaction.begin(err => {
            ...
            request.query("select * from Reglas where campoTablaID = "+this.props.tablaID, (err, result) => {
                if (err) {
                    if (!rolledBack) {
                        console.log(err);
        ...
        if(this.state.mostrarCreacionRegla) {
            return (
                <div>
                                ...
                                <div className={"page-breadcrumb"}>
                                    <nav aria-label="breadcrumb">
                                        <ol className={"breadcrumb"}>
                                            ...
                                            <li className={"breadcrumb-item"} aria-current="page" onClick={this.props.returnSelCredit}><a href="#" className={"breadcrumb-link"}>Seleccionar Tipo de Cr&eacute;dito</a></li>
                    ...
                    <VariableCreation pool={this.props.pool} tablaID={this.props.tablaID}> </VariableCreation>
                </div>
            );
        } else {
            return (
